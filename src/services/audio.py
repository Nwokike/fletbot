...
for multimodal AI processing.

API verified against flet-audio-recorder v0.84.0:
- AudioRecorder(on_state_change=...)
- start_recording(output_path) -> bool
- stop_recording() -> str | None  (returns file path)
"""
...
class AudioService:
    ...
    async def start_recording(self) -> bool:
        ...
        try:
            ...
            self._page.show_dialog(
                ft.SnackBar(content=ft.Text(f"Recording error: {e}"))
            )
            return False
